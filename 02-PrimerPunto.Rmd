...
A partir del capítulo 2 del libro: J. Angrist and J. Pischke (AP): “Mostly harmless econometrics:
...
b) Describa un ejemplo de una evaluación en la que se pueda incurrir en problema de selección
(No use los ejemplos de la lectura)
